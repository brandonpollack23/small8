...
lappend patterns ck_n ${instname}_alt_mem_phy_inst|clk|DDR_CLK_OUT\[*\].ddr_clk_out_n|auto_generated|ddio_outa\[*\]|dataout
	...
	set outputFileName "DRAM_phy_autodetectedpins.tcl"
...
set DRAM_phy_use_high_performance_timing 1
if {[namespace which -variable ::override_DRAM_phy_use_high_performance_timing] != ""} {
	set DRAM_phy_use_high_performance_timing $::override_DRAM_phy_use_high_performance_timing
}
