-- megafunction wizard: %DDR High Performance Controller v13.1%
-- GENERATION: XML

-- ============================================================
-- Megafunction Name(s):
-- 			dram64k_controller_phy
-- ============================================================
-- Generated by DDR High Performance Controller 13.1 [Altera, IP Toolbench 1.3.0 Build 162]
-- ************************************************************
...
ARCHITECTURE SYN OF dram64k IS
	...
	SIGNAL signal_wire11	:  STD_LOGIC_VECTOR (0 DOWNTO 0);
	...
	COMPONENT dram64k_controller_phy
	PORT (
		local_address	: IN STD_LOGIC_VECTOR (22 DOWNTO 0);
		local_write_req	: IN STD_LOGIC;
		local_read_req	: IN STD_LOGIC;
...
BEGIN
	...
	dram64k_controller_phy_inst : dram64k_controller_phy
	PORT MAP (
...
-- Retrieval info: <MEGACORE title="DDR SDRAM Controller with ALTMEMPHY"  version="13.1"  build="162"  iptb_version="1.3.0 Build 162"  format_version="120" >
-- Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRControllerMVCModel"  active_core="dram64k_controller_phy" >
...
-- Retrieval info:      <PRIVATE name = "mem_if_clk_mhz" value="120.0"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "local_if_clk_mhz_label" value="120.0"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "mem_if_clk_ps_label" value="(8333 ps)"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "mem_if_rowaddr_width" value="12"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "mem_if_preset" value="JEDEC DDR-400 128Mb x8"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "alt_top" value="dram64k_alt_mem_ddrx_controller_top"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "nativelink_excludes" value="dram64k_phy_alt_mem_phy_seq_wrapper.vhd,dram64k_phy_alt_mem_phy_seq_wrapper.v,dram64k_phy.vhd,dram64k_phy_alt_mem_phy.v,alt_mem_phy_defines.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "nativelink_includes" value="dram64k_phy.vho,dram64k_phy_alt_mem_phy_seq_wrapper.vho"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "filename" value="dram64k_alt_mem_ddrx_controller_top.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "simgen2">
-- Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+dram64k_alt_mem_phy_seq_wrapper;+dram64k_alt_mem_phy_reconfig;+dram64k_alt_mem_phy_pll;+dram64k_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\Users\Brandon\Dropbox\school\DigDes\labs\small8/dram64k_simgen_init.txt"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
...
-- Retrieval info:      <PRIVATE name = "filename" value="dram64k_syn.v"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
